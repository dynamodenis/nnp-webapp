...
import { deleteResearchCategory } from '../../../redux/actions/research_category';


function DeleteResearchCategory(props) {
    const {deleteResearchCategory,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteResearchCategory(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.research_category.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteResearchCategory})(React.memo(DeleteResearchCategory))
