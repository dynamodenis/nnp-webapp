      ...
      <div className="flex flex-col gap-4 pt-3 justify-between pb-5">
        <div>
          <ValidatorForm ref={form} onSubmit={createCourse} autoComplete='off'>
            ...
            <div className="md:grid md:grid-cols-2 justify-between flex flex-col gap-4">
              <div className="pt-2">
                <label htmlFor="" className="font-semibold text-sm">Duration</label>
                <div className="pt-2">
                  <TextValidator className="text_inputs--pl placeholder:text-slate-400 block bg-white w-full border login-inputs border-slate-300 rounded-md py-2 pl-40 pr-3 text-sm" placeholder="Training duration" type="text" name="search" value={duration} onChange={changeDuration}/>
                </div>
              </div>
            ...
            <div className="justify-between flex flex-col gap-4 pt-2">
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-2">
                  {selectPicture.map(pic => (
                    <img src={pic} alt="" id="img" className="product_img" />
                  ))}
                </div>
