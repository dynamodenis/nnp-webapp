...
import { deleteTrainingCategory } from '../../../redux/actions/training_category';

function DeleteTrainingCategory(props) {
    const {deleteTrainingCategory,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteTrainingCategory(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading:state.training_category.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteTrainingCategory})(React.memo(DeleteTrainingCategory))
