...
import { updateTrainingCategory } from '../../../redux/actions/training_category';
function EditTrainingCategory(props) {
  const {isLoading, edit, updateTrainingCategory} = props
  const form = useRef();
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-2">
        <div>
          <div className="text-2xl font-medium">Edit Training Category</div>
        </div>
      </div>
...
const mapStateToProps = state =>({
  isLoading:state.training_category.isUpdating,
})


export default connect(mapStateToProps,{updateTrainingCategory})(React.memo(EditTrainingCategory));
