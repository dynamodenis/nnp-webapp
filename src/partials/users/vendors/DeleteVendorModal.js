...
import {deleteVendor} from '../../../redux/actions/vendors'


function DeleteVendorModal(props) {
    const {deleteVendor,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteVendor(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.vendors.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteVendor})(React.memo(DeleteVendorModal))
