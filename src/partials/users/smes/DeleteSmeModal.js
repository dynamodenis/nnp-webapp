...
import {deleteSme} from '../../../redux/actions/smes'


function DeleteSmeModal(props) {
    const {deleteSme,setIsOpen,modalIsOpen} = props;
...
const mapStateToProps = state => {
    return{
        isLoading: state.smes.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteSme})(React.memo(DeleteSmeModal))
