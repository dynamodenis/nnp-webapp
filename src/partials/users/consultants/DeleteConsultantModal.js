...
import { deleteConsultant } from '../../../redux/actions/consultants';


function DeleteConsultantModal(props) {
    const {deleteConsultant,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteConsultant(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.consultants.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteConsultant})(React.memo(DeleteConsultantModal))
