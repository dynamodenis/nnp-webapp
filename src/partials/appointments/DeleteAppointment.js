...
function DeleteAppointment(props) {
    const {deleteAppointment,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteAppointment(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.appointments.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteAppointment})(React.memo(DeleteAppointment))
