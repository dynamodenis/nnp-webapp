            ...
            <div className="md:w-36 pt-8 md:float-right ">
              <div className="grid grid-cols-2">
                ...
                {isLoading ? 
                  ...
                  <button type="submit" className="bg-primary-green success-btn rounded-md text-white m-auto text-sm disabled:opacity-50" title="Save" disabled={!name || !category || !trainers}>Update</button>
                }
              </div>
            </div>
