...
import { deleteTraining } from '../../../redux/actions/training';


function DeleteProduct(props) {
    const {deleteTraining,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteTraining(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.trainings.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteTraining})(React.memo(DeleteProduct))
