...
import { deleteProductCategory } from '../../../redux/actions/product_category';


function DeleteProductCategory(props) {
    const {deleteProductCategory,setIsOpen,modalIsOpen} = props;
    ...
    const handleSubmit = event => {
        ...
        deleteProductCategory(selectId).then((res) => {
            if(res === "success"){
...
const mapStateToProps = state => {
    return{
        isLoading: state.product_category.isDeleting,
    }
}

export default connect(mapStateToProps, {deleteProductCategory})(React.memo(DeleteProductCategory))
